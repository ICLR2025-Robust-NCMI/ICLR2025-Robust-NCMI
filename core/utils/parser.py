...
def parser_train():
    ...
    # parser.add_argument('--augment', type=str2bool, defaul`t=True, help='Augment training set.')
    ...
    parser.add_argument('--NCMI', action='store_true', default=False, help='use NCMI')
    parser.add_argument('-param', nargs='*', type=float, default=[1, .05, 0.], help='coefficients apply on loss func')
    parser.add_argument('-SampleSize', type=int, default=64, help='sample size of batch centroid update')
    parser.add_argument('-cdf', type=float, default=.9999, help='centroid decay factor')
    parser.add_argument('--clean_center', action='store_true', default=False, help='apply clean centroids')
    parser.add_argument('--imbalance', action='store_true', default=False, help='normal training without class balance sampling')
    parser.add_argument('--awp', action='store_true', default=False, help='use AWP regularization')
    parser.add_argument('--awp_gamma', type=float, default=5e-3, help='AWP gamma')
    parser.add_argument('--awp_warmup', type=int, default=10, help='number of AWP warmup epochs')
...
def parser_eval():
    ...
    parser.add_argument('--num-samples', type=int, default=10000, help='Number of test samples.')
